...
// 		console.log('---------------------------------------------');
// 		console.log("Product Line: "+result[i].productLine);
// 		var total=0;
// 		for (var j=0;j<months.length;j++){
// 			console.log(months[j]+": "+result[i][months[j]].toFixed(0));
...
// 		console.log(months[i]+": "+monthlytotal[i].toFixed(0));
// 	}
// }
...
// }
// var attributes = ["productLine","closeDate"];

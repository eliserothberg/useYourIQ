...
// 	[column2]:conditions2
// };
// medianDealSize(attributes, searches, startDate, endDate);
// //*************************************************
...
// 	[column2]:conditions2
// };
// salesByMonth(attributes, searches, startDate, endDate);
// //*************************************************
...
// 	[column2]:conditions2
// };
// monthlySalesByPerson(attributes, searches, startDate, endDate);
// //*************************************************
...
// 	[column2]:conditions2
// };
// revenueByProductline(attributes, searches, startDate, endDate);
// //*************************************************
...
// 	[column2]:conditions2
// };
// newBusinessMonthly(attributes, searches, startDate, endDate);
//*************************************************
...
maxMinRevenue(attributes, searches, startDate, endDate);

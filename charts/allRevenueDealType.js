...
function logResults(result, title, dataName, res, thisSymbol) {
  ...
  for (var i = 0; i < result.length; i++) {
    labels[i] = result[i].dealType;
    var total = 0;
    var individual = {};
    var values = [];
    individual.label = labels[i];
    individual.dataType = "Deal Type: ";
  ...
  totalMonthly.dataType = "Deal Type: ";
...
function revenueByDealType(title, dataName, newVersusReturning, startDate, endDate, res, thisSymbol) {
  ...
  grabData(queryString, logResults, title, dataName, res, thisSymbol);
}

module.exports = revenueByDealType;
